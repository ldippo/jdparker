...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'                => get_template_directory_uri() . '/plugins/multiple-post-thumbnails.1.6.zip', // The plugin source
        ...
        array(
            ...
            'source'                => get_template_directory_uri() . '/plugins/layersliderwp-5.1.1.installable.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
     ...
     */
    $config = array(
        'domain'            => 'medicom',           // Text domain - likely want to be the same as your theme.
        ...
        'strings'           => array(
            'page_title'                                => __( 'Install Required Plugins', 'medicom' ),
            'menu_title'                                => __( 'Install Plugins', 'medicom' ),
            'installing'                                => __( 'Installing Plugin: %s', 'medicom' ), // %1$s = plugin name
            'oops'                                      => __( 'Something went wrong with the plugin API.', 'medicom' ),
            ...
            'return'                                    => __( 'Return to Required Plugins Installer', 'medicom' ),
            'plugin_activated'                          => __( 'Plugin activated successfully.', 'medicom' ),
            'complete'                                  => __( 'All plugins installed and activated successfully. %s', 'medicom' ) // %1$s = dashboard link
        )
    );
